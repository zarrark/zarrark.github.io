...
<p id="backbutton"><a href="music.html#thankyou">Go to Thank you</a></p>
...
<p style="float: left; font-size: 9pt; text-align: center; width: 30%; margin-right: 1%; margin-bottom: 0.5em;"><a href="music.html#thankyou"><img src="figures\f_Map_Indus_IIASA_Orig_HYDROBASINS_fromPresent.png" style="width: 100%"></a><a href="music.html#thankyou">Caption 1: Link to thankyou</a></p>

<p style="float: left; font-size: 9pt; text-align: center; width: 30%; margin-right: 1%; margin-bottom: 0.5em;"><img src="figures\f_Map_Indus_IIASA_Orig_HYDROBASINS_fromPresent.png" style="width: 100%">Caption 2</p>

<p style="float: left; font-size: 9pt; text-align: center; width: 30%; margin-right: 1%; margin-bottom: 0.5em;"><img src="figures\f_Map_Indus_IIASA_Orig_HYDROBASINS_fromPresent.png" style="width: 100%">Caption 3</p>
