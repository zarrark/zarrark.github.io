...
# Figure options
titleOn<-1
figWidth_Inch<-figWidth_InchMaster*1
figHeight_Inch<-figHeight_InchMaster
range_x<-range(l1$wt)
range_y<-range(l1$mpg)
breakx_maj<-0.5
breakx_min<-0.25
prettyBreaksy<-prettyBreaksyMaster
...
p <- p +  scale_y_continuous(breaks = pretty_breaks(n = prettyBreaksy))
plot(p)
